...
const TeacherStudentManagement = () => {
    ...
    const handleAssign = async () => {
        try {
            ...
            console.error(err);
            // Handle specific error message for max students
            if (err?.response?.data?.message === "This teacher already has the maximum number of students assigned (10)") {
                message.error("This teacher has already been assigned 10 students.");
            } else {
    ...
    return (
        <div className="p-6">
            ...
            <Row gutter={16}>
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    if (selectedTeacher && selectedTeacher._id === teacher._id) {
                                                        return; // If the same teacher is clicked, do nothing
                                                    }
                                                    setSelectedTeacher(teacher);
                                                }}
                                            >
                ...
                <Col xs={24} sm={12}>
                    {selectedTeacher && (
                        <Card title={`Students of ${selectedTeacher.name}`} bordered={false}>
                            <Table
                                rowKey="_id"
            ...
            <Modal
                ...
                onCancel={() => {
                    ...
                    setAssignedStudentIds([]); // Reset selected users
                }}
                okText="Save"
            >
                <Transfer
