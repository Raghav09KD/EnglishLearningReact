  ...
  return (
    <div className="p-8 space-y-10 bg-gray-50 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          />
           ...
           {user?.role === 'teacher' && <DashboardCard
            ...
            icon={<ListChecks size={24} />}
            color="green"
            link={paths.TEACHER_MANAGE_COURSE_ASSIGNMENTS}
          />}
      ...
      <section>
        ...
        {/* Only for Admins → Manage Teacher's Students + Courses */}
        {user?.role === "admin" && (
          <>
            ...
            <Link to={paths.TEACHER_COURSE_MANAGEMENT}>
              <div className="flex items-center gap-4 mt-4 p-5 border rounded-lg bg-white shadow-sm hover:shadow-md hover:bg-blue-50 transition duration-200 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Assign and remove courses for teachers
                  </p>
                </div>
              </div>
            </Link>
        ...
        {/* Only for Teachers → View All Courses */}
        {user?.role === "teacher" && (
          <Link to={paths.ADMIN_COURSE_TABLE}>
            <div className="flex items-center gap-4 p-5 mt-4 border rounded-lg bg-white shadow-sm hover:shadow-md hover:bg-green-50 transition duration-200 cursor-pointer">
